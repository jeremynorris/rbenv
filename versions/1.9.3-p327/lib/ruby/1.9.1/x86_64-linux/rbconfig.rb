...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/vagrant/.rbenv/versions/1.9.3-p327")
  ...
  CONFIG["configure_args"] = " '--prefix=/vagrant/.rbenv/versions/1.9.3-p327' 'CFLAGS= ' 'LDFLAGS=-L'\\\\''/vagrant/.rbenv/versions/1.9.3-p327/lib'\\\\'' ' 'CPPFLAGS=-I'\\\\''/vagrant/.rbenv/versions/1.9.3-p327/include'\\\\'' '"
  ...
  CONFIG["cppflags"] = "-I'/vagrant/.rbenv/versions/1.9.3-p327/include' "
  CONFIG["NULLCMD"] = ":"
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I'/vagrant/.rbenv/versions/1.9.3-p327/include'  $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L'/vagrant/.rbenv/versions/1.9.3-p327/lib'  -rdynamic -Wl,-export-dynamic"
  CONFIG["CFLAGS"] = " "
  CONFIG["CC"] = "gcc"
